        ...
        <Tab as={Fragment}>
          {({ selected }) => (
            <div
              className={
                selected
                  ? "w-4/5 flex justify-center items-center bg-[#fff] text-[#0693F1] m-auto py-3 my-1 cursor-pointer outline-none rounded-lg"
                  : "w-4/5 flex m-auto py-3 my-1 cursor-pointer text-[#fff]"
              }
            >
              {selected ? (
        ...
        <Tab as={Fragment}>
          {({ selected }) => (
            <div
              className={
                selected
                  ? "w-4/5 flex justify-center items-center bg-[#fff] text-[#0693F1] m-auto py-3 my-1 cursor-pointer outline-none rounded-lg mt-7"
                  : "w-4/5 flex m-auto py-3 my-1 cursor-pointer text-[#fff] mt-7"
              }
            >
              {selected ? (
                <span className="text-[#0693F1]">
